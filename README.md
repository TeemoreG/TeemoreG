...
I’m a results-driven IT professional with a strong foundation in **network infrastructure, web development, and digital automation systems**.  
I help businesses and individuals build secure, scalable, and automated solutions — from networking setups to AI-assisted workflows and marketing systems.

---

### 🧠 What I Do
- 🖧 **Networking & IT Support:** LAN/WAN setup, firewall configuration, VPN deployment, troubleshooting, and user training  
- ⚙️ **Automation & Systems:** Make.com (Zapier), MailerLite, CRM setup, AI content workflows, and digital process automation  
- 🌐 **Web Development:** WordPress design, hosting, and optimization for business websites  
- 🧩 **Cybersecurity & Data Management:** Security best practices, backups, and access control management  
...
- 🏅 **Certifications:** Cisco Cybersecurity Essentials • Google Workspace Administrator  
...
- Developed responsive, SEO-optimized websites for small businesses and tutoring centers.  
